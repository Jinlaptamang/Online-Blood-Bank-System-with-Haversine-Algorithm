...
import "./App.css";
import ClosestDonorsPage from "./Components/Bank/ClosestDonor";
...
export default function App() {
	...
	return (
		<>
			<BrowserRouter>
				<Routes>
					<Route path="/" element={<Navbar logIn={loggedIn} user={loggedIn && user.hospital ? "bank" : "user" } userId={user?._id} />}>
						...
						<Route path="/donors/closest/:bankId" element={<ClosestDonorsPage/>} />
